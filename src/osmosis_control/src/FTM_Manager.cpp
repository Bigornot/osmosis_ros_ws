...
FTM_Manager::FTM_Manager()
{
	...
	FTM_rules_.push_back(new FTM_Rule(4, 2, {}, DM4_node_crash_control_, RM3_respawn_control_nodes_));
	FTM_rules_.push_back(new FTM_Rule(5, 2, {}, DM5_node_crash_, RM4_respawn_nodes_));
